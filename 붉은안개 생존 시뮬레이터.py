...
guards_db = {
    "리카르도": {"cost": 275, "power": 20, "dice": 10},
...
st.markdown("베르케 칸이 마침내 도래했습니다. 1턴부터요! 이거 진짜에요? 네 진짜에요!\ 다행히도 당연히 전력은 아닙니다. 심심해서 24시간 정도 외출 나오셨어요. 그것보다 더 나와계시면 훌라구가 측방을 타격할 거라 돌아가셔야 하고요.\ 그래도 패배하면 '취미생활' 용도로 쓰이는 건 똑같아요. 행운을 빌어요!")
